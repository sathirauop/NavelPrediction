...
if (!apiKey) {
  console.error("⚠️  WARNING: GEMINI_API_KEY environment variable is not set!");
...
Provide your JSON analysis now.`;
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🧠 GEMINI PREDICTION (Simulating ML Model + Analysis)");
    ...
    console.log("⚠️  Using simple fallback calculation\n");
